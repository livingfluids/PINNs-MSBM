...
# ----------------------------------------------------------------------------- 
# SOLVES THE FORWARD PROBLEM FOR ϕ AND Ux USING A FOURIER EXPANSION LAYER
# ----------------------------------------------------------------------------- 
...
ϕ_trial = lambda y: ϕ_max * torch.sigmoid(ϕ_PINN(y.to(device))[:,0:1]) * (1 + y.to(device)) * (1 - y.to(device))  # try BCs in the loss instead 
